...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>FitnessPro</b></span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=" treeview">
          ...
          <ul class="treeview-menu">
            ...
            <i class="fa fa-envelope"></i> <span>Gestion des demandes</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green">new</small>
            </span>
          </a>
            <li><a href="pages/tables/data.html"><i class="fa fa-circle-o"></i> Gestion des comptes actuels</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="pages/widgets.html">
            <i class="fa fa-th"></i> <span>Gestion des activités</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/tables/simple.html"><i class="fa fa-circle-o"></i>Utilisateurs</a></li>
            <li><a href="pages/tables/data.html"><i class="fa fa-circle-o"></i> Entrainement</a></li>
          </ul>
        </li>
        <li>
    ...
    <center>
      <table>
        ...
        @foreach ($users as $value) {
          ...
          <td>{{ $value ->Age }}</td>
          <td>{{ $value ->email }}</td>
          <td><a href=""><button>Bloquer</button></a></td>
        }
        @endforeach
      </table>
    </center>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="https://adminlte.io">FitnessPro</a>.</strong>
  </footer>
